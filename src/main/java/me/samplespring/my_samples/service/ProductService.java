...
import me.samplespring.my_samples.model.mapper.ProductMapperTest;
...
public class ProductService {
    ...
    public ProductDTO get(final Long productNo){
        return this.productRepository.findById(productNo).map(product -> productMapper.convertDTO(product))
